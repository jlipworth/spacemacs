...
This layer reads the following variable:

| *Variable*             | *Default* | *Description*                                                |
|------------------------+-----------+--------------------------------------------------------------|
| =pdf-view-use-scaling= | =t=       | Scale pages for sharper rendering on HiDPI/Retina displays.  |
|                        |           | Set to =nil= if you hit performance problems, e.g. sluggish  |
|                        |           | redisplay after zooming.                                     |

For example, to disable scaling:
