...
| ~latex-enable-magic-symbols-optimization~ | ~t~                                                       | When non-nil, optimize Magic LaTeX's symbol, script, and block scanning         |
...
Spacemacs uses behavior-preserving optimized search and block scanners by
default.  Set
